...
LDLIBSOPTIONS=-lfcgi++ -lfcgi -lgdal -lPocoFoundation -lPocoJSON -lPocoNet -lPocoNetSSL -lgdal_correlator
...
${OBJECTDIR}/Affine2DEstimator.o: Affine2DEstimator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Affine2DEstimator.o Affine2DEstimator.cpp

${OBJECTDIR}/AutoGeoreference.o: AutoGeoreference.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AutoGeoreference.o AutoGeoreference.cpp

${OBJECTDIR}/AwareImageDownloader.o: AwareImageDownloader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AwareImageDownloader.o AwareImageDownloader.cpp

${OBJECTDIR}/Controller.o: Controller.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controller.o Controller.cpp

${OBJECTDIR}/GeoreferencerMetadataProvider.o: GeoreferencerMetadataProvider.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeoreferencerMetadataProvider.o GeoreferencerMetadataProvider.cpp

${OBJECTDIR}/ImageDownloaderManager.o: ImageDownloaderManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageDownloaderManager.o ImageDownloaderManager.cpp

${OBJECTDIR}/ZoomifyImageDownloader.o: ZoomifyImageDownloader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZoomifyImageDownloader.o ZoomifyImageDownloader.cpp

${OBJECTDIR}/ZoomifyPyramid.o: ZoomifyPyramid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZoomifyPyramid.o ZoomifyPyramid.cpp

${OBJECTDIR}/appio.o: appio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/appio.o appio.cpp
